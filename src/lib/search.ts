...
const SYNONYMS: Record<string, string[]> = {
  ...
  'контак':  ['контактор', 'контактора', 'контакторы', 'контактором'],
  ...
  'гильз':   ['гильза', 'гильзы', 'гильзу', 'гильзой'],
  'зазем':   ['заземление', 'заземления', 'заземлением', 'заземлитель'],
  ...
  'опресс':  ['опрессовка', 'опрессовки', 'опрессовкой'],
  'сип':     ['сипа', 'сипу', 'сипом'],
  'ретро':   ['ретро', 'ретро-'],
  'слабот':  ['слаботочная', 'слаботочные', 'слаботочных'],
  'прожект': ['прожектор', 'прожектора', 'прожекторы'],
  ...
  'термор':  ['терморегулятор', 'терморегулятора', 'терморегуляторы', 'термостат'],
